...
sudo cp /vagrant/config/debian.buster.source.list /etc/apt/sources.list

##install ansible
sudo cp /vagrant/config/debian.buster.source.ansible.list /etc/apt/sources.list.d/ansible.list
sudo apt-get update
